import { BigintIsh, Token } from 'dependencies/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermitAbi from '@uniswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
...
export abstract class SelfPermit {
  public static INTERFACE: Interface = new Interface(ISelfPermitAbi.abi)
