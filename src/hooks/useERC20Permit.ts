...
import { Percent, CurrencyAmount, Currency, TradeType, Token } from 'dependencies/sdk-core'
import { Trade as V2Trade } from 'dependencies/v2-sdk'
import { Trade as V3Trade } from 'dependencies/v3-sdk'
import { splitSignature } from 'ethers/lib/utils'
import { useMemo, useState } from 'react'
import { SWAP_ROUTER_ADDRESSES } from '../constants/addresses'
import { USDC_KAKAROT } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1802203764]: {
    [USDC_KAKAROT.address]: { type: PermitType.AMOUNT, name: 'USD Coin', version: '1' },
