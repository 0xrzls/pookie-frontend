import { Currency, CurrencyAmount, TradeType } from 'dependencies/sdk-core'
import { encodeRouteToPath, Route, Trade } from 'dependencies/v3-sdk'
...
const QUOTE_GAS_OVERRIDES: { [chainId: number]: number } = {
  [SupportedChainId.KAKAROT]: 6_000_000,
