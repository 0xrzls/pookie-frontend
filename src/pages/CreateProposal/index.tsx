...
import { Currency, CurrencyAmount, Token } from 'dependencies/sdk-core'
...
const CreateProposalButton = ({
  ...
  return (
    ...
    >
      {hasActiveOrPendingProposal ? (
        <span>You already have an active or pending proposal</span>
      ) : !hasEnoughVote ? (
        <>
          {formattedProposalThreshold ? (
            <span>You must have {formattedProposalThreshold} votes to submit a proposal</span>
          ) : (
            <span>You don&apos;t have enough votes to submit a proposal</span>
          )}
        </>
      ) : (
