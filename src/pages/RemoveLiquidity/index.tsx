...
import { Currency, Percent } from 'dependencies/sdk-core'
...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
    if (!pairContract || !pair || !signer || !deadline) throw new Error('missing dependencies')
  ...
  async function onRemove() {
    if (!chainId || !signer || !account || !deadline || !router) throw new Error('missing dependencies')
          ...
          <TransactionConfirmationModal
            ...
            content={() => (
              <ConfirmationModalContent
                title={<span>You will receive</span>}
                onDismiss={handleDismissConfirmation}
            ...
            <LightCard>
              <AutoColumn gap="20px">
                <RowBetween>
                  ...
                  >
                    {showDetailed ? <span>Simple</span> : <span>Detailed</span>}
                  </ClickableText>
                </RowBetween>
