...
import { Fraction, Percent, Price, Token, CurrencyAmount } from 'dependencies/sdk-core'
...
import { FeeAmount, Pool, Position, priceToClosestTick, TickMath } from 'dependencies/v3-sdk'
        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <TYPE.blue display="inline">
              <span>Uniswap migration contract↗</span>
            </TYPE.blue>
          </ExternalLink>
        )}
        .
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <TYPE.body fontSize={14} style={{ marginBottom: 8, fontWeight: 500, opacity: 0.8 }} textAlign="center">
                <span>
                  You are the first liquidity provider for this PookieSwap pool. Your liquidity will migrate at the
              ...
              <TYPE.body fontWeight={500} textAlign="center" fontSize={14} style={{ marginTop: '8px', opacity: 0.8 }}>
                <span>Your transaction cost will be much higher as it includes the gas to create the pool.</span>
              </TYPE.body>
          ...
          {largePriceDifference ? (
            <YellowCard>
              <AutoColumn gap="8px">
                ...
                <RowBetween>
                  <TYPE.body fontSize={14}>
                    <span>V3 {invertPrice ? currency1.symbol : currency0.symbol} Price:</span>
                  </TYPE.body>
                  <TYPE.black fontSize={14}>
                    {invertPrice
                ...
                <RowBetween>
                  ...
                  <TYPE.black fontSize={14} color="inherit">
                    <span>{priceDifferenceFraction?.toSignificant(4)}%</span>
                  </TYPE.black>
                </RowBetween>
              </AutoColumn>
              <TYPE.body fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <span>
                  You should only deposit liquidity into PookieSwap at a price you believe is correct. <br />
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <TYPE.mediumHeader>
            <span>Migrate V2 Liquidity</span>
          </TYPE.mediumHeader>
        ...
        {!account ? (
          <TYPE.largeHeader>
            <span>You must connect an account.</span>
          </TYPE.largeHeader>
          ...
          <EmptyState message={<span>Loading</span>} />
        )}
      </AutoColumn>
    </BodyWrapper>
  )
