      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<span>Migrate your liquidity tokens from PookieSwap V2 to PookieSwap V3.</span>} />
            </div>
          </AutoRow>

          <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
            <span>
              For each pool shown below, click migrate to remove your liquidity from PookieSwap V2 and deposit it into
              PookieSwap V3.
            </span>
          </TYPE.body>
          ...
          {!account ? (
            <LightCard padding="40px">
              <TYPE.body color={theme.text3} textAlign="center">
                <span>Connect to a wallet to view your V2 liquidity.</span>
              </TYPE.body>
            </LightCard>
          ) : v2IsLoading ? (
            <LightCard padding="40px">
            ...
            <EmptyState message={<span>No V2 Liquidity found.</span>} />
          )}
