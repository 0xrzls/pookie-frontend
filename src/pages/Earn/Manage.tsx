...
import { Token, CurrencyAmount } from 'dependencies/sdk-core'
    ...
    <PageWrapper gap="lg" justify="center">
            ...
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>
                  <span>Step 1. Get UNI-V2 Liquidity tokens</span>
                </TYPE.white>
              </RowBetween>
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
          ...
          <StyledDataCard disabled={disableTop} bgColor={backgroundColor} showBackground={!showAddLiquidityButton}>
            <CardSection>
              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>
                    <span>Your liquidity deposits</span>
                  </TYPE.white>
                </RowBetween>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          <span>When you withdraw, the contract will automagically claim UNI on your behalf!</span>
        </TYPE.main>
            ...
            {stakingInfo && stakingInfo.active && (
              <ButtonPrimary padding="8px" $borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? (
                  ...
                  <span>Deposit UNI-V2 LP Tokens</span>
                )}
              </ButtonPrimary>
            )}
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : !stakingInfo?.active ? null : (
          <TYPE.main>
            <span>{userLiquidityUnstaked.toSignificant(6)} UNI-V2 LP tokens available</span>
          </TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
