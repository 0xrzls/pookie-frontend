...
import { Currency, CurrencyAmount, Percent } from 'dependencies/sdk-core'
...
import { FeeAmount, NonfungiblePositionManager } from 'dependencies/v3-sdk'
        ...
        .then((estimate) => {
          ...
          return signer.sendTransaction(newTxn).then((response: TransactionResponse) => {
            ...
            addTransaction(response, {
              summary: `Create ${currencyA?.symbol}/${currencyB?.symbol} V3 pool`,
            })
  ...
  const Buttons = () =>
    addIsUnsupported ? (
      ...
      <AutoColumn gap={'md'}>
        ...
        >
          <Text fontWeight={600}>{errorMessage ? errorMessage : <span>Preview</span>}</Text>
        </ButtonError>
      </AutoColumn>
    )
              ...
              <Row justifyContent="flex-end" style={{ width: 'fit-content', minWidth: 'fit-content' }}>
                <MediumOnly>
                  <ButtonText
                    ...
                    margin="0 15px 0 0"
                  >
                    <TYPE.blue color={'#FF3C3C'} fontSize="12px" fontWeight={500}>
                      <span>Clear All</span>
                    </TYPE.blue>
                  </ButtonText>
                </MediumOnly>
          ...
          <Wrapper>
            <ResponsiveTwoColumns wide={!hasExistingPosition}>
                  ...
                  <>
                    <AutoColumn gap="md">
                      <RowBetween paddingBottom="20px">
                        <TYPE.label>
                          <Text color={'#1E1E1E'} fontSize={16} fontWeight={600}>
                            Select Pair
                          </Text>
                        </TYPE.label>
                      </RowBetween>
                      ...
                      {noLiquidity && (
                        ...
                        >
                          ...
                          >
                            <span>
                              You are the first liquidity provider for this PookieSwap pool.The transaction cost will be
              ...
              <div>
                ...
                >
                  <AutoColumn gap="md">
                    <TYPE.label color={'#1E1E1E'} fontSize={16} fontWeight={600}>
                      {hasExistingPosition ? <span>Add more liquidity</span> : <span>Deposit Amounts</span>}
                    </TYPE.label>
                              ...
                              <AutoColumn gap="8px" style={{ height: '100%' }}>
                                ...
                                <RowFixed>
                                  <TYPE.yellow ml="12px" fontSize="13px" margin={0} fontWeight={400}>
                                    <span>
                                      On PookieSwap, setting a range across all prices like V2 is less capital efficient
