    ...
    <>
      <PageWrapper gap="lg" justify="center">
        <DelegateModal
          ...
          title={showUnlockVoting ? <span>Unlock Votes</span> : <span>Update Delegation</span>}
        />
        <TopSection gap="md">
          <VoteCard>
            <CardBGImage />
            ...
            <CardSection>
              <AutoColumn gap="md">
                ...
                >
                  <TYPE.white fontSize={14}>
                    <span>Read more about Uniswap governance</span>
                  </TYPE.white>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
                ...
                <RowFixed>
                  ...
                  <AddressButton>
                    <StyledExternalLink
                      ...
                      style={{ margin: '0 4px' }}
                    >
                      {userDelegatee === account ? <span>Self</span> : shortenAddress(userDelegatee)}
                    </StyledExternalLink>
        ...
        <TYPE.subHeader color="text3">
          <span>A minimum threshold of 0.25% of the total UNI supply is required to submit proposals</span>
        </TYPE.subHeader>
      </PageWrapper>
      <SwitchLocaleLink />
    </>
