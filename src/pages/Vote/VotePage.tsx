  ...
  return (
    <>
      <PageWrapper gap="lg" justify="center">
        ...
        <DelegateModal isOpen={showDelegateModal} onDismiss={toggleDelegateModal} title={<span>Unlock Votes</span>} />
        <ProposalInfo gap="lg" justify="start">
          ...
          <AutoColumn gap="10px" style={{ width: '100%' }}>
            ...
            <RowBetween>
              <TYPE.main>
                {endDate && endDate < now ? (
                  <span>Voting ended {endDate && endDate.toLocaleString(DateTime.DATETIME_FULL)}</span>
                ) : proposalData ? (
                  <span>Voting ends approximately {endDate && endDate.toLocaleString(DateTime.DATETIME_FULL)}</span>
                ) : (
                  ''
                )}
              </TYPE.main>
