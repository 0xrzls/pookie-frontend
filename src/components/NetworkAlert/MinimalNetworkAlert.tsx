...
export function MinimalNetworkAlert() {
  ...
  return (
    <Wrapper darkMode={darkMode} chainId={chainId} logoUrl={info.logoUrl}>
      ...
      <Body>
        <span>This is an alpha release of PookieSwap on the {NETWORK_LABELS[chainId]} network.</span>
        <DesktopTextBreak /> <span>You must bridge L1 assets to the network to swap them.</span>
      </Body>
