...
const FocusedOutlineCard = styled(OutlineCard)<{ active?: boolean; pulsing?: boolean }>`
  border-color: ${({ active, theme }) => (active ? theme.primary1 : 'transparent')};
  ...
  return (
    <FocusedOutlineCard pulsing={pulsing} active={active} onFocus={handleOnFocus} onBlur={handleOnBlur} width={width}>
      <AutoColumn gap="6px">
        ...
        <InputRow>
          {!locked && (
            <SmallButton onClick={handleDecrement} disabled={decrementDisabled} backgroundColor="#ffffff !important">
          ...
          {!locked && (
            <SmallButton onClick={handleIncrement} disabled={incrementDisabled} backgroundColor="#ffffff !important">
