...
export const ButtonPrimary = styled(Base)`
  ...
  &:disabled {
    background-color: ${({ theme, altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? '#F1F1F1' : theme.bg2) : theme.bg2};
...
export const ButtonLight = styled(Base)`
  ...
  &:hover {
    background-color: ${({ theme, disabled }) => !disabled && darken(0.03, '#f26619')};
  }
  &:active {
...
const ButtonCheckBgFill = styled(ButtonOutlined)`
  background-color: #f1f1f1;
...
export function ButtonRadioChecked({ active = false, children, ...rest }: { active?: boolean } & ButtonProps) {
  ...
  if (!active) {
    return (
      <ButtonCheckBgFill $borderRadius="12px" padding="12px 8px" {...rest}>
