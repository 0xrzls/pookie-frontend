...
import { Currency, Token } from 'dependencies/sdk-core'
...
const WETH_ONLY: ChainTokenList = {
  [SupportedChainId.KAKAROT]: [WETH9_EXTENDED[SupportedChainId.KAKAROT]],
}
// used to construct intermediary pairs for trading
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [SupportedChainId.KAKAROT]: [...WETH_ONLY[SupportedChainId.KAKAROT], USDC_KAKAROT],
}
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.KAKAROT]: [
    ExtendedEther.onChain(SupportedChainId.KAKAROT),
    WETH9_EXTENDED[SupportedChainId.KAKAROT],
    USDC_KAKAROT,
  ],
}
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
  [1802203764]: [[WETH9_EXTENDED[SupportedChainId.KAKAROT], USDC_KAKAROT]],
}
